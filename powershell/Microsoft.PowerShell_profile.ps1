...
Set-PSReadLineOption -EditMode Emacs -PredictionSource History -MaximumHistoryCount 10000 -HistorySearchCursorMovesToEnd -Colors @{ListPredictionSelected="$([char]0x1b)[48;5;222m"}
if ($false) {
